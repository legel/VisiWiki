...
Please contact sales@egenix.com for evaluation licenses or visit the
    ...
    ext_modules.extend([
        ...
        mx_Extension('mx.ODBC.DataDirect.mxODBC',
                     ...
                     define_macros=[('DataDirect', None),
                                   ...
                                   + _common_defines,
                     needed_includes=[('sql.h',
                                       ['/opt/odbc%sv51/include' % _bits,
                                        ],
                                       'DataDirect Technologies')],
                     needed_libraries=[('odbc',
                                        ['/opt/odbc%sv51/lib' % _bits,
                                         ],
                                        '\[DataDirect\]')],
